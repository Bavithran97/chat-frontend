...
import { faMessage, faRightFromBracket, faSearch } from '@fortawesome/free-solid-svg-icons';
          ...
          <Tooltip label='Search Users to chat' hasArrow placement='bottom-end'>
            <Button variant='ghost' _hover='black' onClick={onOpen}>
              <Text
                ...
                px={4}
              >
                <FontAwesomeIcon icon={faSearch} /> Find User
              </Text>
            </Button>
          </Tooltip>
          <Text fontSize='2xl' color='white' className='heading'>
            <FontAwesomeIcon icon={faMessage} /> ChatPedia
          </Text>
          <div>
            <Menu>
              <MenuButton p={1}>
